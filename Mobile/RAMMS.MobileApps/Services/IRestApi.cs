...
namespace RAMMS.MobileApps
{
    ...
    public interface IRestApi
    {
        ...
        [Post("/api/ddlcodetextconcat")]
        Task<ResponseBaseListObject<DDListItems>> GetActivityCode([Body] DDLookUpDTO formObject);


        [Post("/api/ddlDistressObserved")]
        Task<ResponseBaseListObject<DDListItems>> GetDistressobserved([Body] DDLookUpDTO formObject);
        ...
        [Post("/api/getG1G2GridData")]
        Task<ResponseBaseObject<GridWrapper<object>>> GetFormG1G2LandingGridData([Body] SearchRequestDTO landingGrid);

        [Post("/api/deleteG1G2")]
        Task<ResponseBaseObject<int>> DeleteG1G2Header(int id);

        [Post("/api/findDetailsG1G2")]
        Task<ResponseBaseObject<FormG1DTO>> SaveG1G2Hdr([Body]FormG1DTO frmG1G2);

        [Post("/api/updateG1G2")]
        Task<ResponseBaseObject<int>> UpdateG1G2([Body]FormG1DTO data);

        [Post("/api/getG1G2ById")]
        Task<ResponseBaseObject<FormG1DTO>> GetG1G2ById(int id);

        [Post("/api/getG1G2List")]
        Task<ResponseBaseListObject<DDListItems>> GetGGAssetList([Body] AssetDDLRequestDTO request);

        [Post("/api/getG1G2ImageList")]
        Task<ResponseBaseListObject<FormG1G2ImgRequestDTO>> GetG1G2Images(int id);

        [Post("/api/deleteG1G2Image")]
        Task<ResponseBaseObject<int>> DeleteG1G2Image(int headerid, int imgId);


        //r1r2 End Points
        [Post("/api/getR1R2GridData")]
        Task<ResponseBaseObject<GridWrapper<object>>> GetFormR1R2LandingGridData([Body] SearchRequestDTO landingGrid);

        [Post("/api/deleteR1R2")]
        Task<ResponseBaseObject<int>> DeleteR1R2Header(int id);

        [Post("/api/findDetailsR1R2")]
        Task<ResponseBaseObject<FormR1DTO>> SaveR1R2Hdr([Body] FormR1DTO frmG1G2);

        [Post("/api/updateR1R2")]
        Task<ResponseBaseObject<int>> UpdateR1R2([Body] FormR1DTO data);

        [Post("/api/getR1R2ById")]
        Task<ResponseBaseObject<FormR1DTO>> GetR1R2ById(int id);

        [Post("/api/getR1R2List")]
        Task<ResponseBaseListObject<DDListItems>> GetRRAssetList([Body] AssetDDLRequestDTO request);

        [Post("/api/getR1R2mageList")]
        Task<ResponseBaseListObject<FormRImagesDTO>> GetR1R2Images(int id);

        [Post("/api/deleteR1R2Image")]
        Task<ResponseBaseObject<int>> DeleteR1R2Image(int headerid, int imgId);
        //RR End Points
        ...
        //Form M
        [Post("/api/getMGridData")]
        Task<ResponseBaseObject<GridWrapper<object>>> GetFormMLandingGridData([Body] SearchRequestDTO landingGrid);

        [Post("/api/deleteM")]
        Task<ResponseBaseObject<int>> DeleteFMHeader(int id);

        [Post("/api/findDetailsM")]
        Task<ResponseBaseObject<FormMDTO>> SaveFMHdr([Body] FormMDTO frmFD);

        [Post("/api/updateM")]
        Task<ResponseBaseObject<int>> UpdateFM([Body] FormMDTO frmFD);

        [Post("/api/getMById")]
        Task<ResponseBaseObject<FormMDTO>> GetFMById(int id);
        ...
        Task GetDDLAssetList(DDLookUpDTO ddlist);
    }
}