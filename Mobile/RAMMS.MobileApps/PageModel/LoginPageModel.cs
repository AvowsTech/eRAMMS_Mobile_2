                ...
                return new Command(async (obj) =>
                {
                    ...
                    if (LoginValidate())
                    {
                        ...
                        try
                        {
                            ...
                            ///
                            //AppConst.AppUsername = txtEmailAddress.Trim();
                            ...
                            if (response.success)
                            {
                                ...
                                if (App.AuthToken != null && App.AuthToken != "")
                                {
                                    ...
                                    App.username = txtEmailAddress.Trim();
                                    ...
                                    dashboardPage.AddPage<FormMPageModel>("Temporary Traffic Management Audit (Form M)", true);
                                    dashboardPage.AddPage<FormB1B2PageModel>("Bridge Inspection (Form B1/B2)", true);
                                    dashboardPage.AddPage<FormG1G2PageModel>("Gantry Sign Visual Inspection (Form G1/G2)", true);
                                    dashboardPage.AddPage<FormR1R2PageModel>("Retaining Wall Visual Inspection Record (Form R1/R2)", true);
                                    ...
                                    dashboardPage.AddPage<FormTPageModel>("Traffic Volume Count Form (Form T)", null);
