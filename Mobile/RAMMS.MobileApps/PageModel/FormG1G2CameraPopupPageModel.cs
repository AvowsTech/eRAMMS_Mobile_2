...
{
    public class FormG1G2CameraPopupPageModel : FreshBasePageModel
    {
        ...
        public FormG1G2CameraPopupPageModel(IRestApi restApi, IUserDialogs userDialogs, ILocalDatabase localDatabase)
        {
        ...
        public void listfiles(ObservableCollection<string> ImageList)
        {
            try
            {
                var path1 = "/storage/emulated/0/Pictures/FormG1G2/";
                            ...
                            try
                            {
                                ...
                                using (var formData = new MultipartFormDataContent())
                                {
                                    ...
                                    try
                                    {
                                        ...
                                        var res1 = await client.PostAsync(AppConst.ImageApiBaseFormG1G2Address, formData);
