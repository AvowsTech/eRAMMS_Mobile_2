...
namespace RAMMS.MobileApps.PageModel
{
    ...
    public class FormR1R2CameraPopupPageModel : FreshBasePageModel
    {
        ...
        public FormR1R2CameraPopupPageModel(IRestApi restApi, IUserDialogs userDialogs, ILocalDatabase localDatabase)
        {
        ...
        public void listfiles(ObservableCollection<string> ImageList)
        {
            try
            {
                var path1 = "/storage/emulated/0/Pictures/FormR1R2/";
                            ...
                            try
                            {
                                ...
                                using (var formData = new MultipartFormDataContent())
                                {
                                    ...
                                    try
                                    {
                                        ...
                                        var res1 = await client.PostAsync(AppConst.ImageApiBaseFormR1R2Address, formData);
                                    ...
                                    catch { } //UserDialogs.Instance.Alert(ex.Message + "Details:"+ ex.StackTrace);
                                }
                            }
                            catch (Exception ex)
                            {
