            ...
            try
            {
                ...
                if (user != null && user.Count > 0)
                {
                    ...
                    if (user.FirstOrDefault().IsLoggedIn)
                    {
                        ...
                        dashboardPage.AddPage<FormG1G2PageModel>("Gantry Sign Visual Inspection (Form G1/G2)", null);
                        dashboardPage.AddPage<FormR1R2PageModel>("Retaining Wall Visual Inspection Record (Form R1/R2)", null);

                        dashboardPage.AddPage<FormMPageModel>("Temporary Traffic Management Audit (Form M)", null);
